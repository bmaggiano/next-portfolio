    ...
    <main className="max-w-3xl mx-auto px-4 mt-8 text-white">
      <div className=" flex w-full flex-col justify-center overflow-hidden rounded-lg">
        ...
        <div className="flex flex-col space-y-4">
          <p>
            <span className="text-gray-400">Published on {blog.published}</span>
          </p>
          <h2 className="text-white text-3xl mb-4 font-medium sm:text-3xl md:text-4xl">
            {blog.title}
          </h2>
      ...
      <div className="flex flex-col items-center">
        <Image
          ...
          src={blog.blogImage}
          alt={blog.title}
          className="max-h-[200px] sm:max-h-[300px] object-cover object-bottom rounded-lg my-8"
        />
        <article
