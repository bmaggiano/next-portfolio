...
export default function Jumbotron() {
    return (
        <main className="flex flex-col items-center justify-center gap-y-4 px-4 py-16 sm:px-6 lg:px-8">
            ...
            <p className="max-w-[42rem] text-center leading-normal text-muted-foreground sm:text-xl sm:leading-8">Crafting React and Next.js magic. Step into my portfolio, where code meets creativity.</p>
